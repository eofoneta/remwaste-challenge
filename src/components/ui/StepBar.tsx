...
const StepBar = ({ steps, currentStep }: StepBarProps) => {
  return (
    <div className="flex items-center justify-center max-w-6xl mx-auto my-6 shadow-2xl rounded-3xl p-2">
        ...
        return (
          <div key={index} className="flex-1 flex items-center">
            ...
            >
              ...
              <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 w-max text-sm hidden sm:block text-white">
